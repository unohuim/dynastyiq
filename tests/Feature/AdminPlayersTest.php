...
function mockPlatformState($test, bool $seeded = true, bool $initialized = true, bool $upToDate = true): void
{
    ...
    $test->app->instance(PlatformState::class, $platform);
}
...
it('requires platform seeding before allowing access', function () {
    mockPlatformState($this, seeded: false, initialized: false, upToDate: false);
...
it('redirects uninitialized platforms to initialization flow', function () {
    mockPlatformState($this, seeded: true, initialized: false, upToDate: false);
