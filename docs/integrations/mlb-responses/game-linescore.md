...
| Path Template | `/game/{gamePk}/linescore` |
| Registry Key | `game_linescore` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/linescore` |
