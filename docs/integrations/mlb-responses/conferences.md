...
| Path Template | `/conferences` |
| Registry Key | `conferences` |
...
| Parameter | Notes |
| --- | --- |
| `conferenceId` | Provider-supported query parameter; verify accepted values before implementation. |
