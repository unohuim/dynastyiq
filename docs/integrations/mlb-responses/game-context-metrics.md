# MLB Game Context Metrics Response
...
| Path Template | `/game/{gamePk}/contextMetrics` |
| Registry Key | `game_contextMetrics` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/contextMetrics` |
