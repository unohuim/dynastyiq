...
| Path Template | `/teams/{teamId}/roster` |
| Registry Key | `team_roster` |
| Category | `Teams And Rosters` |
| Example URL | `https://statsapi.mlb.com/api/v1/teams/119/roster` |
...
| Parameter | Notes |
| --- | --- |
| `rosterType` | Provider-supported query parameter; verify accepted values before implementation. |
