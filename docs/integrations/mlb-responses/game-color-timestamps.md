# MLB Game Color Timestamps Response
...
| Path Template | `/game/{gamePk}/feed/color/timestamps` |
| Registry Key | `game_color_timestamps` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/feed/color/timestamps` |
