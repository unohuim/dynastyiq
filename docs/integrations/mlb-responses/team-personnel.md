...
| Path Template | `/teams/{teamId}/personnel` |
| Registry Key | `team_personnel` |
| Category | `Teams And Rosters` |
| Example URL | `https://statsapi.mlb.com/api/v1/teams/119/personnel` |
