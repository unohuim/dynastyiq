...
| Path Template | `/schedule` |
| Registry Key | `schedule` |
| Category | `Schedule And Discovery` |
| Example URL | `https://statsapi.mlb.com/api/v1/schedule?sportId=1&date=2026-08-28` |

## Parameters

Required parameter sets: `sportId`; or `gamePk`; or `gamePks`.

| Parameter | Notes |
| --- | --- |
| `scheduleType` | Provider-supported query parameter; verify accepted values before implementation. |
| `eventTypes` | Provider-supported query parameter; verify accepted values before implementation. |
...
| `sportId` | Provider-supported query parameter; verify accepted values before implementation. |
| `gamePk` | Provider-supported query parameter; verify accepted values before implementation. |
| `gamePks` | Provider-supported query parameter; verify accepted values before implementation. |
| `venueIds` | Provider-supported query parameter; verify accepted values before implementation. |
| `gameTypes` | Provider-supported query parameter; verify accepted values before implementation. |
| `date` | Provider-supported query parameter; verify accepted values before implementation. |
...
| `opponentId` | Provider-supported query parameter; verify accepted values before implementation. |
...
Document candidate MLB schedule and game-change endpoints for discovering games and tracking provider updates.
