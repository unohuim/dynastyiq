...
| Path Template | `/uniforms/game` |
| Registry Key | `game_uniforms` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/uniforms/game` |

## Parameters

Required parameter sets: `gamePks`.
