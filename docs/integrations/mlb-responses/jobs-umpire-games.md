# MLB Jobs Umpire Games Response
...
| Path Template | `/jobs/umpires/games/{umpireId}` |
| Registry Key | `jobs_umpire_games` |
| Category | `Operations And Context` |
| Example URL | `https://statsapi.mlb.com/api/v1/jobs/umpires/games/1234` |
