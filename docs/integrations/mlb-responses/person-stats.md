...
| Path Template | `/people/{personId}/stats/game/{gamePk}` |
| Registry Key | `person_stats` |
| Category | `People And Players` |
| Example URL | `https://statsapi.mlb.com/api/v1/people/660271/stats/game/746001` |
