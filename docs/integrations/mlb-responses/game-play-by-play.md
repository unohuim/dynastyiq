# MLB Game Play By Play Response
...
| Path Template | `/game/{gamePk}/playByPlay` |
| Registry Key | `game_playByPlay` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/playByPlay` |
