...
| Path Template | `/teams/{teamId}/leaders` |
| Registry Key | `team_leaders` |
| Category | `Teams And Rosters` |
| Example URL | `https://statsapi.mlb.com/api/v1/teams/119/leaders` |

## Parameters

Required parameter sets: `leaderCategories`, `season`.
