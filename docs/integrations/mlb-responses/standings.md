...
| Path Template | `/standings` |
| Registry Key | `standings` |
| Category | `Standings And Seasons` |
| Example URL | `https://statsapi.mlb.com/api/v1/standings?leagueId=103&season=2026` |

## Parameters

Required parameter sets: `leagueId`.
...
| `standingsTypes` | Provider-supported query parameter; verify accepted values before implementation. |
