...
| Path Template | `/jobs/datacasters` |
| Registry Key | `jobs_datacasters` |
| Category | `Operations And Context` |
| Example URL | `https://statsapi.mlb.com/api/v1/jobs/datacasters?sportId=1` |
