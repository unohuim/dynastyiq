...
| Path Template | `/gamePace` |
| Registry Key | `gamePace` |
| Category | `Stats And Leaders` |
| Example URL | `https://statsapi.mlb.com/api/v1/gamePace?sportId=1` |

## Parameters

Required parameter sets: `season`.

| Parameter | Notes |
| --- | --- |
| `season` | Provider-supported query parameter; verify accepted values before implementation. |
| `teamIds` | Provider-supported query parameter; verify accepted values before implementation. |
| `leagueIds` | Provider-supported query parameter; verify accepted values before implementation. |
| `leagueListId` | Provider-supported query parameter; verify accepted values before implementation. |
...
| `orgType` | Provider-supported query parameter; verify accepted values before implementation. |
| `includeChildren` | Provider-supported query parameter; verify accepted values before implementation. |
