# MLB Schedule Postseason Tune In Response
...
| Path Template | `/schedule/postseason/tuneIn` |
| Registry Key | `schedule_postseason_tuneIn` |
| Category | `Schedule And Discovery` |
| Example URL | `https://statsapi.mlb.com/api/v1/schedule/postseason/tuneIn?sportId=1` |
