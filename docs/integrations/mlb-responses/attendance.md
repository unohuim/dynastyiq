...
| Registry Key | `attendance` |
| Category | `Operations And Context` |
| Example URL | `https://statsapi.mlb.com/api/v1/attendance` |

## Parameters

Required parameter sets: `teamId`; or `leagueId`; or `leagueListid`.
