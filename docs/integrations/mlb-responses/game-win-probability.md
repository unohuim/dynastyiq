# MLB Game Win Probability Response
...
| Path Template | `/game/{gamePk}/winProbability` |
| Registry Key | `game_winProbability` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/winProbability` |
...
| Parameter | Notes |
| --- | --- |
| `timecode` | Provider-supported query parameter; verify accepted values before implementation. |
