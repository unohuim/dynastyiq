...
| Path Template | `/homeRunDerby/{gamePk}{bracket}{pool}` |
| Registry Key | `homeRunDerby` |
| Category | `Events` |
| Example URL | `https://statsapi.mlb.com/api/v1/homeRunDerby/746001` |
...
Document candidate MLB event-specific endpoints.
