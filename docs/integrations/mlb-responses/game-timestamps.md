...
| Path Template | `/game/{gamePk}/feed/live/timestamps` |
| Registry Key | `game_timestamps` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/feed/live/timestamps` |
