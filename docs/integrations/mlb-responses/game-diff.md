...
| Path Template | `/game/{gamePk}/feed/live/diffPatch` |
| Registry Key | `game_diff` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/feed/live/diffPatch` |
