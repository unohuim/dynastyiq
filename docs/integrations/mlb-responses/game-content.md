...
| Path Template | `/game/{gamePk}/content` |
| Registry Key | `game_content` |
| Category | `Game Detail` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/746001/content` |
...
| Parameter | Notes |
| --- | --- |
| `highlightLimit` | Provider-supported query parameter; verify accepted values before implementation. |
