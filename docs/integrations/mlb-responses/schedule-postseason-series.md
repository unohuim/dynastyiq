# MLB Schedule Postseason Series Response
...
| Path Template | `/schedule/postseason/series` |
| Registry Key | `schedule_postseason_series` |
| Category | `Schedule And Discovery` |
| Example URL | `https://statsapi.mlb.com/api/v1/schedule/postseason/series?sportId=1` |
...
| `seriesNumber` | Provider-supported query parameter; verify accepted values before implementation. |
