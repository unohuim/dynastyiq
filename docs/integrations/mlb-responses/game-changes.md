...
| Path Template | `/game/changes` |
| Registry Key | `game_changes` |
| Category | `Schedule And Discovery` |
| Example URL | `https://statsapi.mlb.com/api/v1/game/changes?sportId=1` |

## Parameters

Required parameter sets: `updatedSince`.

| Parameter | Notes |
| --- | --- |
| `updatedSince` | Provider-supported query parameter; verify accepted values before implementation. |
