...
| Path Template | `/transactions` |
| Registry Key | `transactions` |
| Category | `Transactions` |
| Example URL | `https://statsapi.mlb.com/api/v1/transactions?sportId=1&date=2026-08-28` |

## Parameters

Required parameter sets: `teamId`; or `playerId`; or `date`; or `startDate`, `endDate`.
...
Document candidate MLB transaction endpoints before using provider transaction data in DynastyIQ workflows.
