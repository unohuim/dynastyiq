...
/**
 * Builds SAT /60 projection rows for one model-run entity.
 */
class BuildNhlSatModelEntityRateProjectionForEntityJob implements ShouldQueue
{
    use Batchable;
    use Queueable;
    ...
    /**
     * Prevent duplicate /60 builds for the same model-run entity.
     */
    ...
    {
        return [
            'nhl-sat-model-entity-rate-projection',
    ...
    {
        Log::error('NHL SAT model entity /60 projection job failed.', [
    ...
    {
        return 'nhl-sat-model-entity-rate-projection:'
            . $this->modelRunId . ':'
            . $this->profileType . ':'
            . sha1($this->entityKey);
    }
