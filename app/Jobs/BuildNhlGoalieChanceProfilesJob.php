...
/**
 * Coordinates historical goalie chance-profile jobs.
 */
class BuildNhlGoalieChanceProfilesJob implements ShouldQueue, ShouldBeUnique
{
    use Queueable;
    ...
    {
        return 'nhl-goalie-chance-profiles:' . $this->sourceSeasonId . ':' . $this->gameType;
    }
    ...
    public function handle(NhlGoalieChanceProfileBuilder $builder): void
    {
        ...
        $jobs = array_map(
            fn (int $goaliePlayerId): BuildNhlGoalieChanceProfileForGoalieJob => new BuildNhlGoalieChanceProfileForGoalieJob(
        ...
        if ($jobs === []) {
            Log::warning('No NHL goalie chance profile jobs were queued.', [
        ...
        Log::info('NHL goalie chance profile jobs queued.', [
            'source_season_id' => $setup['source_season_id'],
            'game_type' => $setup['game_type'],
            'goal_model_id' => $setup['goal_model_id'],
            'sog_model_id' => $setup['sog_model_id'],
    ...
    {
        Log::error('NHL goalie chance profiles job failed.', [
