...
<template>
  <div class="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div v-if="payload.games.length" class="grid gap-5 lg:grid-cols-2"><GameCard v-for="game in payload.games" :key="game.nhl_game_id" :game="game" :can-manage-lineups="canManageGameSync" @lineup-submitted="applyManualLineup" /></div>
