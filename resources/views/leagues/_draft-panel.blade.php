@php
    ...
    $draftRounds = $drafting['rounds'] ?? [];
    $draftStatusDotClass = match ($drafting['status_tone'] ?? 'slate') {
...
<section
    x-data="{
        activeRound: @js($drafting['active_round_index'] ?? 0),
        showAvatars: true,
        showTeamBadges: true,
        init() {
    ...
    class="relative flex min-h-[42rem] overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:h-[calc(100vh-13rem)] lg:flex-col"
>
