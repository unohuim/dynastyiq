                ...
                <div class="border-y border-gray-200 bg-gray-50">
                    ...
                    <div class="border-t border-gray-200 px-4 py-3">
                        ...
                        <div x-show="!gameImports.loading && gameImportVisibleRuns().length > 0" class="space-y-1.5">
                            ...
                            <div
                                x-show="gameImports.pagination.total > gameImports.pagination.perPage"
                                x-cloak
                            ...
                            >
                                ...
                                <div class="min-w-0 text-center text-[11px] text-gray-500" x-text="gameImportPaginationText()"></div>
