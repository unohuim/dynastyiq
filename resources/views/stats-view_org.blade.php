        ...
        >
            ...
            <template x-if="isMobile">
                  ...
                  <div id="perspectivesBar" class="top-0 z-40">
                    ...
                    <div class="flex">
                      <button type="button" class="searchbar-button-mobile">
                        <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" data-slot="icon" aria-hidden="true" class="searchbar-svg-mobile">
                          <path 
