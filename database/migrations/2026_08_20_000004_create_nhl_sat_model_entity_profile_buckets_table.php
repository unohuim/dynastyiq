...
return new class extends Migration
{
    ...
    {
        Schema::create('nhl_sat_model_entity_profile_buckets', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index(['model_run_id', 'profile_type'], 'ix_nhl_sat_model_entity_profiles_type');
            $table->index(['model_run_id', 'matched_bucket_key'], 'ix_nhl_sat_model_entity_profiles_bucket');
            $table->index(['profile_type', 'entity_id'], 'ix_nhl_sat_model_entity_profiles_entity');
        });
    }
    ...
    {
        Schema::dropIfExists('nhl_sat_model_entity_profile_buckets');
    }
};
